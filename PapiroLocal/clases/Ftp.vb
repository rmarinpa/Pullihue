...
Public Class Ftp
    ...
    Public Function existeObjeto(ByVal dir As String) As Boolean
        ...
        Try
            ...
            Dim respuestaFTP As FtpWebResponse
            respuestaFTP = DirectCast(peticionFTP.GetResponse(), FtpWebResponse)
            MsgBox(respuestaFTP)
            'Dim ftp As FtpWebRequest = DirectCast(FtpWebRequest.Create(servidorFTP & frm_solicitud_ticket.lbl_fecha.Text), FtpWebRequest)
            Return True
        Catch ex As Exception
