...
Public Class Complementarios
    ...
    Public Function listar() As DataTable
        ...
        nue_var.da = New MySqlDataAdapter("SELECT * FROM Complementarios order by codigo1 desc", nue_conexion.conex())
    ...
    Public Sub insertar(ByVal codigo1 As String, ByVal descripcion1 As String, ByVal codigo2 As String, ByVal descripcion2 As String)
        nue_var.consulta = "INSERT INTO Complementarios VALUES('', ?codigo1, ?descripcion1, ?codigo2, ?descripcion2)"
        Try
            nue_conexion.conectar()
    ...
    Public Sub modificar(ByVal Cod_Petroleo As Integer, ByVal codigo1 As String, ByVal descripcion1 As String, ByVal codigo2 As String, ByVal descripcion2 As String)
        nue_var.consulta = "UPDATE Complementarios SET codigo1 = ?codigo1, descripcion1 = ?descripcion1, codigo2 = ?codigo2, descripcion2 = ?descripcion2 WHERE Id_complementario = ?Cod_Petroleo"
        Try
            nue_conexion.conectar()
            nue_var.cmd = New MySqlCommand(nue_var.consulta, nue_conexion.conex())
    ...
    Public Sub eliminar(ByVal cod_petroleo As Integer)
        nue_var.consulta = "Delete from Complementarios WHERE Id_complementario = " & cod_petroleo & ""
        Try
            nue_conexion.conectar()
            nue_var.cmd = New MySqlCommand(nue_var.consulta, nue_conexion.conex())
            nue_var.cmd.ExecuteNonQuery()
