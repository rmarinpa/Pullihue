...
Public Class Nota_de_Credito
    ...
    Public Function listar(ByVal cliente As String) As DataTable

        nue_var.dt = New DataTable
        nue_conexion.conectar()
        nue_var.da = New MySqlDataAdapter("SELECT * FROM venta_nota where cliente like '%" & cliente & "%' order by numero_folio desc, fecha desc, hora desc", nue_conexion.conex())
    ...
    Public Sub insertar(ByVal cliente As String, ByVal rut As String, ByVal area_negocio As String, ByVal senal_advertencia As String, ByVal comuna As String, ByVal familia_1 As String, ByVal familia_2 As String, ByVal familia_3 As String, ByVal tipo_1 As String, ByVal medidas As String, ByVal codigo_producto As String, ByVal proveedor As String, ByVal descripcion As String, ByVal area_calc As Double, ByVal cantidad As Double, ByVal area_total As Double, ByVal venta_rollo As Double, ByVal unit_venta_m2 As Double, ByVal venta_neta As Double, ByVal venta_iva As Double, ByVal venta_total As Double, ByVal condicion As String, ByVal forma_pago As String, ByVal dias_pago As String, ByVal ejecutivo As String, ByVal observaciones As String, ByVal precio_lista As Double, ByVal precio_cliente As Double, ByVal fecha As String, ByVal pedido As Double, ByVal fecha_act As Date, ByVal hora As Date, ByVal descuento As Double, ByVal folio As Double, ByVal toma_pedido As String, ByVal ancho As Double, ByVal largo As Double, ByVal solicitado As String)
        ...
        Try
            ...
            nue_var.cmd.Parameters.Add("?fecha", MySql.Data.MySqlClient.MySqlDbType.VarChar).Value = fecha
    ...
    Public Function listar9(ByVal medida1 As String, ByVal medida2 As String) As DataTable
        ...
        Return listar9
    End Function
    Public Function listar10(ByVal cliente As String, ByVal numero_pedido As Double) As DataTable
    ...
    Public Sub insertar3(ByVal folio As Double, ByVal numero_pedido As String, ByVal cliente As String)
        nue_var.consulta = "INSERT INTO folio4 VALUES('', ?folio, ?numero_pedido, ?cliente)"
        Try
            nue_conexion.conectar()
            nue_var.cmd = New MySqlCommand(nue_var.consulta, nue_conexion.conex())
            nue_var.cmd.Parameters.Add("?folio", MySql.Data.MySqlClient.MySqlDbType.Double).Value = folio
    ...
    Public Function listar16(ByVal nombre_cliente As String) As DataTable
        nue_var.dt = New DataTable
        nue_conexion.conectar()
        nue_var.da = New MySqlDataAdapter("SELECT * FROM venta_nota_folio where cliente like '%" & nombre_cliente & "%' order by numero_folio desc", nue_conexion.conex())
        nue_var.da.Fill(nue_var.dt)
        nue_conexion.desconectar()
        listar16 = nue_var.dt
        Return listar16
    ...
    Public Function listar16(ByVal cliente As String, ByVal numero_pedido As Double) As DataTable
        ...
        Return listar16
    End Function
    Public Sub insertar5(ByVal Folio As Double, ByVal Fecha As Date, ByVal Hora As Date, ByVal Fecha_desp As String, ByVal toma_pedido As String, ByVal solicitado As String, ByVal observaciones As String, ByVal comuna_despacho As String, ByVal direccion_despacho As String)
        nue_var.consulta = "INSERT INTO Notas_de_pedido_val VALUES('', ?Folio, ?Fecha, ?Hora, ?Fecha_desp, ?toma_pedido, ?solicitado, ?observaciones, ?comuna_despacho, ?direccion_despacho)"
        Try
            nue_conexion.desconectar()
            nue_conexion.conectar()
            nue_var.cmd = New MySqlCommand(nue_var.consulta, nue_conexion.conex())
    ...
    Public Function listar17() As DataTable
        ...
        nue_var.dt = New DataTable
        nue_conexion.conectar()
        nue_var.da = New MySqlDataAdapter("SELECT * FROM Notas_de_pedido_val order by Id_notas_de_pedido asc", nue_conexion.conex())
        nue_var.da.Fill(nue_var.dt)
        nue_conexion.desconectar()
        listar17 = nue_var.dt
        Return listar17
    ...
    Public Sub eliminar3(ByVal cod_Mov_Tierra As Integer)
        ...
        End Try
    End Sub
    Public Function listar19(ByVal toma_pedido As String) As DataTable

        nue_var.dt = New DataTable
        nue_conexion.conectar()
        nue_var.da = New MySqlDataAdapter("SELECT * FROM Notas_de_pedido_val_aut where toma_pedido like '" & toma_pedido & "' order by Id_notas_de_pedido desc", nue_conexion.conex())
        nue_var.da.Fill(nue_var.dt)
        nue_conexion.desconectar()
        listar19 = nue_var.dt
        Return listar19
    ...
    Public Function listar20() As DataTable
        ...
        nue_var.dt = New DataTable
        nue_conexion.conectar()
        nue_var.da = New MySqlDataAdapter("SELECT * FROM Notas_de_pedido_val_aut order by Id_notas_de_pedido desc", nue_conexion.conex())
        nue_var.da.Fill(nue_var.dt)
        nue_conexion.desconectar()
        listar20 = nue_var.dt
        Return listar20()
