...
Public Class Frm_clientes_busqueda_rp
    ...
    Private Sub dgv_clientes_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_clientes.DoubleClick
        ...
        Else
            frm_mod_pagos.txt_nombre.Text = dgv_clientes.CurrentRow.Cells(2).Value.ToString()
            frm_mod_pagos.txt_rut.Text = dgv_clientes.CurrentRow.Cells(1).Value.ToString()
            Me.Close()
        End If
    End Sub
