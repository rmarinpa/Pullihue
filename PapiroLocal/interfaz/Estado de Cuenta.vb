...
Public Class Estado_de_Cuenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Estado de Cuenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstado_de_Cuenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Estado_de_Cuenta = New Estado_de_Cuenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
