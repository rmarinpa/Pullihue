Public Class CR_guia_de_despacho_aut2
    ...
    Private Sub CR_Codigo_petroleo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Report1.SetParameterValue("numero_folio", Frm_autorizar.txt_folio.Text)
        Report1.SetParameterValue("usuario_dup", Nombre_Obra)

        If nue_report.reemprimir(Frm_autorizar.txt_folio.Text, 0) >= 1 Then
    ...
    Private Sub printButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        hora = TimeOfDay
        tipo_doc = 0
        numero_pedido = Frm_autorizar.txt_folio.Text
        cuenta_imp = 1
