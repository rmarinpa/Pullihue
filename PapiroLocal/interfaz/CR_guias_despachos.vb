...
Public Class CR_guias_despachos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.CR_guias_despachos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_folio_guia() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCR_guias_despachos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_guias_despachos = New CR_guias_despachos()
        rpt.Site = Me.Site
        Return rpt
    End Function
