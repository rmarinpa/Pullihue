...
Public Class Registro_llamada3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Registro_llamada3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegistro_llamada3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Registro_llamada3 = New Registro_llamada3()
        rpt.Site = Me.Site
        Return rpt
    End Function
