...
Public Class Libro_autorizacion2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Libro_autorizacion2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Libro_autorizacion2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLibro_autorizacion2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Libro_autorizacion2 = New Libro_autorizacion2()
        rpt.Site = Me.Site
        Return rpt
    End Function
