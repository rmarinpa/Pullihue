...
Public Class Nota_Credito_con
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Nota_Credito_con.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNota_Credito_con
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Nota_Credito_con = New Nota_Credito_con()
        rpt.Site = Me.Site
        Return rpt
    End Function
