...
Public Class Frm_clientes_busqueda_pago
    ...
    Private Sub dgv_clientes_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_clientes.DoubleClick
        ...
        Else
            frm_registro_facturas_cliente.txt_cliente.Text = dgv_clientes.CurrentRow.Cells(2).Value.ToString()
            frm_registro_facturas_cliente.txt_rut.Text = dgv_clientes.CurrentRow.Cells(1).Value.ToString()
            Me.Close()
        End If
    End Sub
