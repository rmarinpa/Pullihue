Public Class CR_guia_de_despacho2
    ...
    Private Sub CR_Codigo_petroleo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Report1.SetParameterValue("cliente", frm_prod_despachados.cmb_cliente.Text)
        Report1.SetParameterValue("numero_pedido", frm_prod_despachados.cmb_pedido.Text)

        Report1.SetParameterValue("usuario_dup", Nombre_Obra)

        If nue_report.reemprimir(frm_prod_despachados.cmb_pedido.Text, 0) >= 1 Then
    ...
    Private Sub printButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        hora = TimeOfDay
        tipo_doc = 0
        numero_pedido = frm_prod_despachados.cmb_pedido.Text
        cuenta_imp = 1
