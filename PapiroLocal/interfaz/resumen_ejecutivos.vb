...
Public Class resumen_ejecutivos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.resumen_ejecutivos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedresumen_ejecutivos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As resumen_ejecutivos = New resumen_ejecutivos()
        rpt.Site = Me.Site
        Return rpt
    End Function
