...
Public Class Prueba_sueldos2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Prueba_sueldos2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrueba_sueldos2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Prueba_sueldos2 = New Prueba_sueldos2()
        rpt.Site = Me.Site
        Return rpt
    End Function
