...
Public Class CR_guia_de_despacho4
    ...
    Private Sub CR_Codigo_petroleo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Report1.SetParameterValue("numero_folio", Frm_consulta_pedido_fact.txt_pedido.Text)
        Report1.SetParameterValue("usuario_dup", Nombre_Obra)

        If nue_report.reemprimir(Frm_consulta_pedido_fact.txt_pedido.Text, 0) >= 1 Then
