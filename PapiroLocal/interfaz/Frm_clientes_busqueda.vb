...
Public Class Frm_clientes_busqueda
    ...
    Private Sub dgv_clientes_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_clientes.DoubleClick
        ...
        Else
            frm_registro_llamada.txt_cliente.Text = dgv_clientes.CurrentRow.Cells(2).Value.ToString()
            frm_registro_llamada.txt_rut.Text = dgv_clientes.CurrentRow.Cells(1).Value.ToString()
            frm_registro_llamada.cmb_telefono.Text = dgv_clientes.CurrentRow.Cells(5).Value.ToString()
            frm_registro_llamada.txt_contacto_pago.Text = dgv_clientes.CurrentRow.Cells(10).Value.ToString()
            frm_registro_llamada.txt_cargo_pago.Text = dgv_clientes.CurrentRow.Cells(11).Value.ToString()
            frm_registro_llamada.txt_telefonos_pago.Text = dgv_clientes.CurrentRow.Cells(12).Value.ToString()
            frm_registro_llamada.txt_email_pago.Text = dgv_clientes.CurrentRow.Cells(13).Value.ToString()

            frm_registro_llamada.txt_direccion_facturacion.Text = dgv_clientes.CurrentRow.Cells(3).Value.ToString()
            frm_registro_llamada.txt_comuna_facturacion.Text = dgv_clientes.CurrentRow.Cells(4).Value.ToString()
            frm_registro_llamada.txt_direccion_despacho.Text = dgv_clientes.CurrentRow.Cells(20).Value.ToString()
            frm_registro_llamada.txt_comuna_despacho.Text = dgv_clientes.CurrentRow.Cells(21).Value.ToString()
