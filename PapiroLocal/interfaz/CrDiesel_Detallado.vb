...
Public Class CrDiesel_Detallado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.CrDiesel_Detallado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrDiesel_Detallado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrDiesel_Detallado = New CrDiesel_Detallado()
        rpt.Site = Me.Site
        Return rpt
    End Function
