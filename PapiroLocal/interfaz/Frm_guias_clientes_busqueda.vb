...
Public Class Frm_guias_clientes_busqueda
    ...
    Private Sub dgv_clientes_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_clientes.DoubleClick
        ...
        Else
            frm_sel_guia.txt_cliente.Text = dgv_clientes.CurrentRow.Cells(2).Value.ToString()
            frm_sel_guia.txt_rut.Text = dgv_clientes.CurrentRow.Cells(1).Value.ToString()
            frm_sel_guia.Show()
            frm_sel_guia.actualizar_facturas()
            Me.Close()
        End If
    End Sub
