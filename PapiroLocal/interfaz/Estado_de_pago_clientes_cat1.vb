...
Public Class Estado_de_pago_clientes_cat2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Estado_de_pago_clientes_cat.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Estado_de_pago_clientes_cat.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedEstado_de_pago_clientes_cat2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Estado_de_pago_clientes_cat = New Estado_de_pago_clientes_cat()
        rpt.Site = Me.Site
        Return rpt
    End Function
