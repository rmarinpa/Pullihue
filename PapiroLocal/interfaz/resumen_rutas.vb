...
Public Class resumen_rutas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.resumen_rutas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedresumen_rutas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As resumen_rutas = New resumen_rutas()
        rpt.Site = Me.Site
        Return rpt
    End Function
