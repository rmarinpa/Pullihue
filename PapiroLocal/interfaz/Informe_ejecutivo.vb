...
Public Class Informe_ejecutivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_ejecutivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_ejecutivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_ejecutivo = New Informe_ejecutivo()
        rpt.Site = Me.Site
        Return rpt
    End Function
