Public Class Frm_Sustitutos

    Dim nue_report As New clases.Sustitutos
    ...
    Sub actualizar_dgv()
        ...
        dgv_Petroleo.Columns(1).HeaderText = "Producto Sustituto 1"
        dgv_Petroleo.Columns(2).HeaderText = "Descripción"
        dgv_Petroleo.Columns(3).HeaderText = "Producto Sustituto 2"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Frm_productos_sustito1.Show()
    End Sub

    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Frm_productos_sustito2.Show()
    End Sub
End Class