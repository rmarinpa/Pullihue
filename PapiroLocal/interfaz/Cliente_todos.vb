...
Public Class Cliente_todos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Cliente_todos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCliente_todos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cliente_todos = New Cliente_todos()
        rpt.Site = Me.Site
        Return rpt
    End Function
