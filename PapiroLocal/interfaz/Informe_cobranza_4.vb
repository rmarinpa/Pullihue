...
Public Class Informe_cobranza_4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_cobranza_4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_cobranza_4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_cobranza_4 = New Informe_cobranza_4()
        rpt.Site = Me.Site
        Return rpt
    End Function
