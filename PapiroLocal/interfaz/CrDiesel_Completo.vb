...
Public Class CrDiesel_Completo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.CrDiesel_Completo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrDiesel_Completo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrDiesel_Completo = New CrDiesel_Completo()
        rpt.Site = Me.Site
        Return rpt
    End Function
