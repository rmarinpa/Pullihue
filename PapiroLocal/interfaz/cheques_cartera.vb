...
Public Class cheques_cartera
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.cheques_cartera.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcheques_cartera
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cheques_cartera = New cheques_cartera()
        rpt.Site = Me.Site
        Return rpt
    End Function
