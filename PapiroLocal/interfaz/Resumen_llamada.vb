...
Public Class Resumen_llamada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Resumen_llamada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedResumen_llamada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Resumen_llamada = New Resumen_llamada()
        rpt.Site = Me.Site
        Return rpt
    End Function
