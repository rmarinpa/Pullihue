...
Public Class Frm_productos_sustito2
    ...
    Private Sub dgv_clientes_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_clientes.DoubleClick
        Frm_Sustitutos.txt_codigo2.Clear()
        Frm_Sustitutos.txt_descripcion2.Clear()
        Frm_Sustitutos.txt_codigo2.Text = dgv_clientes.CurrentRow.Cells(1).Value.ToString()
        Frm_Sustitutos.txt_descripcion2.Text = dgv_clientes.CurrentRow.Cells(3).Value.ToString()
        Me.Close()
    End Sub
