...
Public Class mapa_productos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.mapa_productos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmapa_productos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As mapa_productos = New mapa_productos()
        rpt.Site = Me.Site
        Return rpt
    End Function
