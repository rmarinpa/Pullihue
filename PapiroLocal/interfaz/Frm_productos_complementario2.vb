...
Public Class Frm_productos_complementario2
    ...
    Private Sub dgv_clientes_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_clientes.DoubleClick
        Frm_Complementarios.txt_codigo2.Clear()
        Frm_Complementarios.txt_descripcion2.Clear()
        Frm_Complementarios.txt_codigo2.Text = dgv_clientes.CurrentRow.Cells(1).Value.ToString()
        Frm_Complementarios.txt_descripcion2.Text = dgv_clientes.CurrentRow.Cells(3).Value.ToString()
        Me.Close()
    End Sub
