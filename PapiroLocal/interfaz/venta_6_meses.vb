...
Public Class venta_6_meses
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.venta_6_meses.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedventa_6_meses
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As venta_6_meses = New venta_6_meses()
        rpt.Site = Me.Site
        Return rpt
    End Function
