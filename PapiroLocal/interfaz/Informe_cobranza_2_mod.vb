...
Public Class Informe_cobranza_2_mod
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Informe_cobranza_2_mod.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_cobranza_2_mod.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_cobranza_2_mod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_cobranza_2_mod = New Informe_cobranza_2_mod()
        rpt.Site = Me.Site
        Return rpt
    End Function
