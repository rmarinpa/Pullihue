...
Public Class Frm_clientes_busqueda_serv
    ...
    Private Sub dgv_clientes_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_clientes.DoubleClick
        ...
        Else
            frm_solicitud_servicio.txt_cliente.Text = dgv_clientes.CurrentRow.Cells(2).Value.ToString()
            frm_solicitud_servicio.txt_telefono.Text = dgv_clientes.CurrentRow.Cells(5).Value.ToString()
            frm_solicitud_servicio.txt_direccion.Text = dgv_clientes.CurrentRow.Cells(3).Value.ToString()
            frm_solicitud_servicio.txt_comuna.Text = dgv_clientes.CurrentRow.Cells(4).Value.ToString()
            Me.Close()
        End If
    End Sub
