...
Public Class venta_mensual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.venta_mensual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedventa_mensual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As venta_mensual = New venta_mensual()
        rpt.Site = Me.Site
        Return rpt
    End Function
