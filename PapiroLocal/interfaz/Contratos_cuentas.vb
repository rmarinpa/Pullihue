...
Public Class Contratos_cuentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Contratos_cuentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedContratos_cuentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Contratos_cuentas = New Contratos_cuentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
