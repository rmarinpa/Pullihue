...
Public Class Informe_cobranza1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_cobranza1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_cobranza1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_cobranza1 = New Informe_cobranza1()
        rpt.Site = Me.Site
        Return rpt
    End Function
