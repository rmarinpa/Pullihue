...
Public Class Informe_cobranza60
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_cobranza60.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_cobranza60
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_cobranza60 = New Informe_cobranza60()
        rpt.Site = Me.Site
        Return rpt
    End Function
