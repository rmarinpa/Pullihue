...
Public Class Informe_categorias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_categorias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_categorias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_categorias = New Informe_categorias()
        rpt.Site = Me.Site
        Return rpt
    End Function
