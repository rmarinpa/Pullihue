...
Public Class Informe_diesel2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_diesel2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_diesel2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_diesel2 = New Informe_diesel2()
        rpt.Site = Me.Site
        Return rpt
    End Function
