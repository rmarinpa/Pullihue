...
Public Class Libro_compras2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Libro_compras2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLibro_compras2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Libro_compras2 = New Libro_compras2()
        rpt.Site = Me.Site
        Return rpt
    End Function
