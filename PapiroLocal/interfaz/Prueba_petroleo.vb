...
Public Class Prueba_petroleo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Prueba_petroleo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrueba_petroleo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Prueba_petroleo = New Prueba_petroleo()
        rpt.Site = Me.Site
        Return rpt
    End Function
