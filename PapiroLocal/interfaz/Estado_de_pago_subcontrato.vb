...
Public Class Estado_de_pago_subcontrato
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Estado_de_pago_subcontrato.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Estado_de_pago_subcontrato.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstado_de_pago_subcontrato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Estado_de_pago_subcontrato = New Estado_de_pago_subcontrato()
        rpt.Site = Me.Site
        Return rpt
    End Function
