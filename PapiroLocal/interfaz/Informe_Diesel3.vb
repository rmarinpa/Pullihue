...
Public Class Informe_Diesel3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_Diesel3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_Diesel3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_Diesel3 = New Informe_Diesel3()
        rpt.Site = Me.Site
        Return rpt
    End Function
