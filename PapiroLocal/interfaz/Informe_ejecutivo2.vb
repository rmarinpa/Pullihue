...
Public Class Informe_ejecutivo2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Informe_ejecutivo2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_ejecutivo2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_ejecutivo2 = New Informe_ejecutivo2()
        rpt.Site = Me.Site
        Return rpt
    End Function
