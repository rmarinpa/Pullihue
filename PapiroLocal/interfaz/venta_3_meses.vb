...
Public Class venta_3_meses
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.venta_3_meses.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedventa_3_meses
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As venta_3_meses = New venta_3_meses()
        rpt.Site = Me.Site
        Return rpt
    End Function
