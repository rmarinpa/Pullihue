...
Public Class retiro_documentos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.retiro_documentos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedretiro_documentos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As retiro_documentos = New retiro_documentos()
        rpt.Site = Me.Site
        Return rpt
    End Function
