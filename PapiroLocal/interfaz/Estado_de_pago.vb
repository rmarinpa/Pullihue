...
Public Class Estado_de_pago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Constructora_FV.Estado_de_pago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstado_de_pago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Estado_de_pago = New Estado_de_pago()
        rpt.Site = Me.Site
        Return rpt
    End Function
